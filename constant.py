...
# 表格头
DIT_LIST = {
    '账号配置': {'cn': ['全选', '#', '账号', '授权码', '邮箱类型', '产品'], 'en': ['id', 'name', 'pwd', 'str_type', 'product']},
    '邮件标题': {'cn': ['全选', '#', '邮件标题', '产品', '语种'], 'en': ['id', 'str_title', 'product' 'language']},
    '邮件正文': {'cn': ['全选', '#', '邮件正文', '产品', '语种'], 'en': ['id', 'str_body', 'product' 'language']},
    '邮件附件': {'cn': ['全选', '#', '附件地址', '产品', '语种'], 'en': ['id', 'url', 'product' 'language']},
