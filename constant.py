...
# 表格头
DIT_LIST = {
    '账号配置': {'cn': ['全选', '#', '账号', '授权码', '邮箱类型', '语言'], 'en': ['id', 'name', 'pwd', 'str_type', 'language']},
    '邮件标题': {'cn': ['全选', '#', '邮件标题', '语言'], 'en': ['id', 'str_title', 'language']},
    '邮件正文': {'cn': ['全选', '#', '邮件正文', '语言'], 'en': ['id', 'str_body', 'language']},
    '邮件附件': {'cn': ['全选', '#', '附件地址', '语言'], 'en': ['id', 'url', 'language']},
